...
WebUI.setText(findTestObject('Object Repository/Page_Tokobuah Admin - Products/input_Name_name'), 'Apel')

WebUI.setText(findTestObject('Object Repository/Page_Tokobuah Admin - Products/input_Price_price'), '22000')

WebUI.setText(findTestObject('Object Repository/Page_Tokobuah Admin - Products/textarea_Description_description'), 'Ini apel enak banget')

WebUI.uploadFile(findTestObject('Page_Tokobuah Admin - Products/input_Photo_image'), 'D:\\foto2mb.jpg')
